 ...
 * under the License.
 */
package org.os890.ds.addon.demo.web.ee;

import org.os890.ds.addon.demo.spring.PrototypeSpringBean;
...
public class RequestScopedCdiBean
{
    ...
    {
        return getClass().getName() + " <- " + this.prototypeSpringBean.getValue();
    }
}
